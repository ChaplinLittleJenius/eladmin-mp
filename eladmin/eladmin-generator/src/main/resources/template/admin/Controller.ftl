...
<PageResult<${className}>> query${className}(${className}QueryCriteria criteria){
Page
<Object> page = new Page<>(criteria.getPage(), criteria.getSize());
    ...
    <Object> create${className}(@Validated @RequestBody ${className} resources){
        ...
        <Object> update${className}(@Validated @RequestBody ${className} resources){
            ...
            public ResponseEntity
            <Object> delete${className}(@ApiParam(value = "传ID数组[]") @RequestBody List<${pkColumnType}> ids) {
